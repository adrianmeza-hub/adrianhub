...
class Dinosaurio extends Objeto {
	constructor(){
		...
		this.img.src = "imagenes/trexbb.png";
...
class Cactus extends Objeto {
	constructor(x){
		...
		this.siguiente = null;
		this.img.src = "imagenes/cactus2.png";
...
//funcion para iniciar juego la que se llama en el onclick de html
function iniciar(){
